                ...
                <div class="form-card">
                    <div class="row">
                        <div class="col-md-8 mb-4">
                            ...
                            <input type="text" name="name" id="name" class="form-control border-gold-focus @error('name') is-invalid @enderror" placeholder="e.g. Hair Care, Skin Care" value="{{ old('name') }}" required>
                            @error('name')
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="description" id="description" rows="4" class="form-control border-gold-focus @error('description') is-invalid @enderror" placeholder="Write description notes about this inventory category...">{{ old('description') }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
