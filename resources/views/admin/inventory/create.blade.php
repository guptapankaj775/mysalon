                ...
                <form action="{{ route('admin.inventory.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <input type="text" name="item_name" id="item_name" class="form-control" placeholder="e.g. Lavender Shampoo, Professional Scissors" value="{{ old('item_name') }}" required>
                        </div>

                        <!-- SKU -->
                        <div class="col-md-4">
                            <label for="sku" class="form-label font-weight-bold">SKU (Stock Keeping Unit)</label>
                            <input type="text" name="sku" id="sku" class="form-control" placeholder="e.g. SH-LAV-001" value="{{ old('sku') }}">
                        </div>

                        <!-- Description -->
                        <div class="col-12">
                            <label for="description" class="form-label font-weight-bold">Description</label>
                            <textarea name="description" id="description" rows="3" class="form-control" placeholder="Add some notes about this item...">{{ old('description') }}</textarea>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="unit_value" id="unit_value" class="form-control" min="0" step="0.01" placeholder="e.g. 1, 100, 250, 500" value="{{ old('unit_value') }}">
                        </div>

                        <!-- Quantity -->
                        <div class="col-md-4">
                            <label for="quantity" class="form-label font-weight-bold">Initial Quantity <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="min_quantity" id="min_quantity" class="form-control" min="0" value="{{ old('min_quantity', 5) }}" required>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" name="price" id="price" class="form-control" min="0" step="0.01" value="{{ old('price', 0.00) }}" required>
